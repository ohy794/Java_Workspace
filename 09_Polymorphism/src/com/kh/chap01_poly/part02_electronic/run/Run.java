...
public class Run {
	...
	public static void main(String[]args) {
		...
		// 1. 메서드의 매개변수에 다형성(부모타입 레퍼런스로 자식객체를 받아줌)을 적용시키기 전
//		ElectronicController1 ec = new ElectronicController1();
		//생성과 동시에 이 클래스의 필드값(desk, tab, note)들이 메모리영역에 null값으로 추가됨
		//Desktop d = new Desktop("삼성","데탑",800000,"Geforce1070");
//		ec.insert(new Desktop("삼성","데탑",800000,"Geforce1070"));
...
//		System.out.println(t);
		...
		ec.insert(new Desktop("삼성", "데탑", 990000, "Geforce1070"), 0);
...
//		}
		...
		/*
		 * 다형성을 사용하는 이유
		 * 1. 부모타입의 객체배열로 다양한 자식들을 받아줄 수 잇음
		 * 	  => 부모타입 하나만으로 다양한 자식객체들을 다룰 수있음
		 * 2. 메서드의 매개변수나 반환형에 다형성을 적용하게 되면 메서드 갯수가 확 줄어든다.
		 */
	}
}
