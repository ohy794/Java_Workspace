...
public class Student {
	...
	// 이름값을 기록 및 수정할 수 있는 기능의 메소드 (name 필드에 값을 넣기위한 용도)
	// set+필드명 => 두 단어를 이어줄 때 카멜케이스 활용하여 메서드명 선언
	...
	public void setName(String name) {
		...
		// 필드명과 매개변수명이 동일한경우 {}영역 내에서는 해당역ㅇㄱ에서 만들어진 변수가 좀 더 우선순위가 높기 때문 
		// 객체의 name에 접근하려면 this를 사용해야 한다.
		// this에는 생성된 객체의 주소값이 담겨있음
		this.name = name;
	}
	...
	//키 값을 기록 및 수정할 수 있는 기능의 메소드(height필드에 값을 대입하기위한 용도)	
	...
	// 모든 필드값을 한나의 문자열로 합쳐서 돌려주는 용도의 메소드
