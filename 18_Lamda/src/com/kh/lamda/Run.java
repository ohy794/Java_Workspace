...
public class Run {
	/*
	 * 람다식이란? 익명함수(제목이 없는 함수)처럼 구동됨. (java8버젼 이후부터 사용가능)
	 * 실제로는 익명구현 객체(이름없는클래스)를 생성하여 내부에 내가 작성한 코드를 실행시키는 방식으로 구동됨.
	 * 
	...
	@FunctionalInterface // 내부적으로 1개의 미구현 함수를 지닌 인터페이스(람다식으로 사용할 인터페이스),(강제하는 어노테이션)
	...
	public static void main(String[] args) {
		...
		lamda4 l4;
		l4 = a -> a * a;//매개변수가 하나면 () 생략가능, 코드가 단순 return문이 끝이라면 중괄호도 생략 가능 
