...
public class Run {
	public static void main(String[] args) {
		...
		//우선순위 변경 전
		// 스레드는 기본적으로 1 ~ 10 의 우선순위중 5의 우선순위를 가지고 있음
		 ...
		 * 주의점은 스레드 중 한개라도 setDaemon으로 설정시 모든 스레드에 setDaemon설정을 해줘야함
		 * 
		 */
		System.out.println("메인 스레드의 끝부분");
		// 시작순서는 운선순위와 다를 수 있지만 종료순서는 우선순위(priority)가 높은 순으로 끝나게 됨(항상 그렇지 않음)
	}
}
