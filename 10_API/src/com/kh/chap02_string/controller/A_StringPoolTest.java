...
public class A_StringPoolTest {
	...
	public void method1() {
		...
		// String클래스의 hashCode()메서드의 경우 주소값 기반이 아닌 실제 담긴 문자열 기반으로 해시코드값을
		//반환하도록 오버라이딩 되어있음
		
		// 정말 주소값을 알고싶을 때 사용하는 메서드 System.indentityHashCode(참조변수(레퍼런스변수));
