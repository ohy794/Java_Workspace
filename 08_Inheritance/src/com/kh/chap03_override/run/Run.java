...
public class Run {
	...
	public static void main(String[] args) {
		...
		/*
		 * 출력문 안에 래퍼런스 변수를 제시해서 출력하고자 할 때
		 * 내부적으로 JVM이 자동으로 toString() 메소드를 호출함
		 * 
		 * 부모클래스인 Object클래스에 있는 toString()
		 * 해당 래퍼런스의 풀 클래스명 + @ + 해당객체의 주소값의 16진수
		 * 
		 * 자식클래스인 Book클래스에서 toString()메서드를 재정의
		 * 해당 객체의 모든 필드값을 하나의 문자열로 합쳐서 돌려주는 메소드로 재정의됨
		 * 
		 */
		
		System.out.println(bk);
		//메서드 변경 전
		//com.kh.chap03_override.model.vo.Book@53bd815b < Object.toString이 호출되어서 그렇다.
		//메서드 변경 후
