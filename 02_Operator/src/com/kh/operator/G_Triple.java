...
public class G_Triple {
	 ...
	 * 
	 * [표현법]
	 * 조건식 ? 조건식이 true 일경우 결과값: 조건이 false일 경우의 결과값
	 * 
	 */
	public void method1() {
		...
		//산술연산이 삼항 연산보다 우선순위가 높아서 괄호로 묶어주어야 한다.
	...
	public void method2() {
		...
		System.out.printf("%d은(는) %s\n", num,(num%2==0?"짝수입니다.":"홀수입니다."));
		sc.close();
	}
	public void method3() {
		
		//사용자로부터 영문자 하나를 입력받아 대문자인지, 아닌지 판별 후 출력(아스키 코드 활용)
		Scanner sc = new Scanner(System.in);
		
		System.out.print("영문자 한개만 입력 : ");
		char ch = sc.nextLine().charAt(0);
		
		String result = (65<=ch)&&(ch<='Z')?"대문자입니다.":"대문자가 아닙니다.";
	...
	public void method4() {
		...
		System.out.println("사용자가 입력한 값인 "+ num + "은(는) "+ result);
